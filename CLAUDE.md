...
| "módulo transfer omni+correas BF \<n\>" | `python pipeline/modulo_transfer.py projects/<X> [--bf --paso --banda …]` → frame de canal plegado, ejes hex con omnis (RUEDA-OMNI-58), casetes de correa con eje común y snub, 2 UniDrive, soportes FR8ZZ y tapa ranurada. DISEÑO capa `user` con verificación propia (encaje BF, tangencias, envolvente ≥120°, apoyo de caja mínima, holguras, STL estancos). Decisiones en `projects/<X>/DECISIONES.md`. |
