...
PIEZAS = [
    ('m64v8_placa_A_izq.stl', 'A_izq', False, (60.0, 195.0)),
    ('m64v8_placa_B_izq.stl', 'B_izq', True,  (140.0, 195.0)),
    ('m64v8_placa_A_der.stl', 'A_der', False, (60.0, 115.0)),
    ('m64v8_placa_B_der.stl', 'B_der', True,  (140.0, 115.0)),
]
piezas, tot = [], 0.0
...
trimesh.util.concatenate([m for _, m in piezas]).export(p('M64V8_cama.3mf'))
...
ax.set_title(f'Mecanum64 v8 — un PAR de ruedas por cama (4 placas)\n'
             f'{tot:.1f} cm³ ≈ {tot*1.04:.0f} g PA-CF a 100 %', fontsize=11)
fig.tight_layout(); fig.savefig(p('M64V8_cama.png'), facecolor='white')
print('cama ok')
