...
tm = trimesh.load(p('bloque_omni_zp_v4.glb'))
parts = []
...
def matbo(n, M):
    ...
    if 'motor_blk' in n: return M['VERDE']
    if 'spool_blk' in n or 'polea' in n or 'idler' in n: return M['CARR']
...
# 1: la maquina completa con el modulo angosto en su zona
escena('BO4Z_conveyor.png', (1.9, -2.4, 1.6), (0, 0, -0.15), 42, (2100, 1100))
# 2: la zona de cerca — se ve la ZONA MUERTA libre al lado del modulo
escena('BO4Z_zona.png', (0.75, -0.95, 0.75), (0, 0, 0.03), 48, (1900, 1150),
       xlim=(-0.75, 0.75))
# 3: planta de la zona
escena('BO4Z_planta.png', (0.0, 0.0, 2.0), (0, 0, 0.1), 50, (1700, 1100),
       xlim=(-0.62, 0.62))
# 4: transmision: las 2 bandas Poly-V apiladas en el lado muerto, motores
#    con su placa de 8 a la base, rieles de 4 con F6801
escena('BO4Z_transmision.png', (0.42, -0.85, 0.42), (0, -0.04, 0.0), 50,
       (1900, 1100), skip=('tapa_', 'ZP_LT_G:2', 'ZP_GUARDA_MIR'),
       xlim=(-0.75, 0.75))
# 5: frente desde el lado muerto: modulo apoyado en los travesanos sobre
#    las pestanas inferiores
escena('BO4Z_frente.png', (0.0, -1.5, 0.18), (0, 0, 0.03), 70, (1900, 900),
       skip=('ZP_LT_G:2', 'ZP_GUARDA_MIR'), xlim=(-0.85, 0.85))
print('ALL DONE')
