...
tm = trimesh.load(p('bloque_omni_zp.glb'))
parts = []
...
# 1: la maquina completa con el bloque en su zona central
escena('BO3Z_conveyor.png', (1.9, -2.4, 1.6), (0, 0, -0.15), 42, (2100, 1100),
       skip=('cancamo',))
# 2: la zona central de cerca (solo |x|<0.75 m)
escena('BO3Z_zona.png', (0.75, -0.95, 0.75), (0, 0, 0.03), 48, (1900, 1150),
       skip=('cancamo',), xlim=(-0.75, 0.75))
# 3: planta de la zona
escena('BO3Z_planta.png', (0.0, 0.0, 2.0), (0, 0, 0.1), 50, (1700, 1100),
       skip=('cancamo',), xlim=(-0.62, 0.62))
# 4: desde el lado motriz, sin larguero cercano: transmision del bloque
#    entre las zonas ZP vecinas (casetes y motores reales alrededor)
escena('BO3Z_perfil.png', (0.35, -0.95, 0.30), (0, 0, 0.02), 50, (1900, 1050),
       skip=('cancamo', 'ZP_LT_G:2', 'ZP_GUARDA_MIR', 'tapa_', 'lateral'),
       xlim=(-0.9, 0.9))
print('ALL DONE')
