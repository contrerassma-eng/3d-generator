...
tm = trimesh.load(p('bloque_omni_v2.glb'))
parts = []
...
def matbo(n, M):
    ...
    if 'spool' in n or 'carrete' in n: return M['CARR']
    if 'tapa' in n: return M['TAPA']
    if 'buje' in n: return M['PVC']
    if 'oring' in n.lower() or n.startswith('or_'): return M['VERDE2']
    if 'eje' in n or 'varilla' in n or 'cancamo' in n: return M['STEEL']
    return M['PLACAG']
...
escena('BO2_hero.png', (0.78, -0.88, 0.72), (0, 0, 0.02), 50, (1900, 1150),
       skip=('cancamo',))
escena('BO2_planta.png', (0.0, 0.0, 1.7), (0, 0, 0.09), 55, (1500, 1150),
       skip=('cancamo',))
escena('BO2_transmision.png', (0.35, -0.75, 0.28), (0, 0.05, 0.00), 52,
       (1900, 1150), skip=('tapa_', 'ZP_', 'placa_der', 'cancamo'))
escena('BO2_frente.png', (0.0, -1.35, 0.30), (0, 0, 0.06), 75, (1900, 850),
