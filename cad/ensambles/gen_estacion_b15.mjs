...
const doc = {
  ...
  meta: {
    ...
    fuente: 'gen_estacion_b15.mjs — v3: cabezal cilíndrico compacto en norma (tubo EN ISO 1452 + tóricas ISO 3601 regla Parker)',
    fecha: '2026-07-20',
    desviaciones: [
      ...
      'El manual sonda_b15_manual_ensamble.pdf corresponde a la v2 (gabinete rectangular): pendiente de regenerar para v3.',
    ],
