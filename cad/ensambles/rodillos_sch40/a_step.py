...
Salidas (en `step/`):
  rodillos_sch40_ensamble.step   — un solo STEP con todas las piezas nombradas
...
def main():
    ...
    ap.add_argument("--doc", default=str(AQUI / "rodillos_sch40.json"))
    ...
    destino = out / "rodillos_sch40_ensamble.step"
