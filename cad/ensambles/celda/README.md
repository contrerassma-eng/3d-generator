...
| | |
|---|---|
| Celda | hexágono de **195.3 mm entre caras** (radio de rueda R = 71 mm) |
| Módulo 3×3 | **68.4 × 56.4 cm** |
...
sólidos B-rep (OpenCascade); R = 71 mm es el primer radio con cero solapes.
...
2. **La rueda está modelada por su envolvente** Ø48 × 24.5, no con sus rodillos.
   Para interferencias y para la ranura de la placa la envolvente es la cota que
   manda y es conservadora, pero no sirve para estudiar el contacto rodante.
3. **El soporte del motor y el bastidor no están modelados.** Están en el
   despiece; falta su geometría.

## La alternativa que encoge la celda

Los 195 mm salen de que el tren completo —rodamiento, rueda, rodamiento, acople,
